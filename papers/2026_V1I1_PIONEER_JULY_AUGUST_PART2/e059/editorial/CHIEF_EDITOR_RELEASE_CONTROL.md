# e059 Chief Editor release control

- Title and author names are transcribed from the supplied manuscript and require final Chief Editor sign-off.
- Proposed DOI: `10.68232/cj.e059`. It is not a registered or resolvable DOI until authenticated Crossref deposit succeeds and the target landing page resolves.
